...
public class EmpleadoRepoImpl implements EmpleadoRepo {
    ...
    @Override
    public Integer guardarEmpleado(String cedula, String direccion, String nombre, LocalDateTime fechaContratacion,String clave) {

        System.out.println("Entro al metodo guardarRepo");
        int r = entityManager.createNativeQuery("INSERT INTO Empleado (cedula, direccion,nombre,fecha_contratacion,clave) VALUES (?,?,?,?,?)")
                .setParameter(1, cedula)
                .setParameter(2, direccion)
                .setParameter(3, nombre)
                .setParameter(4, fechaContratacion)
    ...
    @Override
    public Integer actualizarEmpleado(String cedula, String direccion, String idCargo, String jefeInmediato, String tipoContrato,String clave,String nombre) {

        int r;
        r = entityManager.createNativeQuery("UPDATE empleado SET direccion = ?,cargo_codigo=?,jefe_inmediato_cedula=?,tipo_contrato_codigo=?,clave=?,nombre=? WHERE cedula=?")
                .setParameter(1, direccion)
                .setParameter(2, idCargo)
                .setParameter(3, jefeInmediato)
                .setParameter(4, tipoContrato)
                .setParameter(5,clave)
